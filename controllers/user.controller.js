...
const subscribe = async (req, res) => {
  try {
    ...
    const picture = req.file ? req.file.filename : "" ;  // Le nom du fichier téléchargé avec l'extension
    ...
    const user = await User.create({
      ...
      role: role,
      phone: phone,
      picture: `Picture/user_profile/${picture}`, // Assurez-vous que "picture" inclut l'extension du fichier
    });  
